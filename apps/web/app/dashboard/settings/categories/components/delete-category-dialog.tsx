                ...
                <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-orange-900 dark:text-orange-100">
                                    Warning: This category may have associated transactions
                                </p>
                                <p className="mt-1 text-sm text-orange-800 dark:text-orange-200">
                                    All associated transactions will be affected. This action cannot be undone.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        <p className="text-sm text-muted-foreground">
                            This action is permanent and cannot be undone. To confirm, please type the category name below:
                        </p>
                        <input
                            type="text"
                            value={confirmText}
